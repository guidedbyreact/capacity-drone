    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <section id="contact" className="py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <a 
            href="/contact" 
            className="inline-block bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-full text-lg transition-all transform hover:scale-105"
          >
            Obtenir un devis
          </a>
        </div>
